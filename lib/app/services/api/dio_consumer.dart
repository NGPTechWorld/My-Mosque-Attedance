  ...
  dynamic request({
    ...
    try {
      if (method == Method.post) {
        ...
        response = await dio.delete(url, options: options, data: params);
      } else if (method == Method.patch) {
        response = await dio.patch(url, options: options, data: params);
      } else if (method == Method.put) {
        response = await dio.put(url, options: options, data: params);
      } else {
